	...
	<div class="navbar navbar-fixed-top scroll-hide">
	  <div class="container-fluid top-bar">
	      ...
	      <ul class="nav navbar-nav pull-right">
	        <#--<li class="dropdown messages hidden-xs">-->
	          <#--<a class="dropdown-toggle" data-toggle="dropdown" href="#"><span aria-hidden="true" class="se7en-envelope"></span>-->
	            <#--<div class="sr-only">-->
	              <#--Notifications到梦空间活动积分查询系统到梦空间活动积分查询系统-->
	            <#--</div>-->
	            <#--<p class="counter">-->
	              <#--111-->
	            <#--</p>-->
	        ...
	        <li class="dropdown user hidden-xs">
	          ...
	          <ul class="dropdown-menu">
	            <li><a href="${request.contextPath }/admin/index">
	    ...
	    <button class="navbar-toggle"><span class="icon-bar"></span>
			  ...
			  <a class="${request.contextPath }/admin/index" href="javascripts:;">到梦空间活动积分查询系统</a>
	  ...
	  <div class="container-fluid main-nav clearfix">
	    <div class="nav-collapse">
	      <ul class="nav">
	        <li>
	          <a class="<#if index == 'index'> current </#if>" href="${request.contextPath }/admin/index"><span aria-hidden="true" class="se7en-home"></span>主页</a>
	        </li>
			  <li class="dropdown <#if index == 'activity'> current </#if>  "><a data-toggle="dropdown" class="<#if index == 'activity'> current </#if> " href="#">
					  <span aria-hidden="true" class="se7en-star"></span>活动管理<b class="caret"></b></a>
				  <ul class="dropdown-menu">
					  <li><a href="${request.contextPath }/admin/activity/list">
				...
				<li class="<#if index == 'integral'> current </#if>  dropdown"><a data-toggle="dropdown" class="<#if index == 'integral'> current </#if>" href="#">
				  <span aria-hidden="true" class="glyphicon glyphicon-star"></span>积分管理<b class="caret"></b></a>
				  <ul class="dropdown-menu">
					<li><a href="${request.contextPath }/admin/integral/list">
					  <span class="notifications label label-warning">New</span>
					  <p>
						积分列表
					  </p></a>
				...
				<li class="<#if index == 'student'> current </#if> dropdown"><a data-toggle="dropdown" class="<#if index == 'student'> current </#if>" href="#">
					  <span aria-hidden="true" class="glyphicon glyphicon-user"></span>学生管理<b class="caret"></b></a>
				  <ul class="dropdown-menu">
					  <li><a href="${request.contextPath }/admin/student/list">
							  <span class="notifications label label-warning">New</span>
							  <p>
								  学生列表
							  </p></a>
			  ...
			  <li>
				  <a class="<#if index == 'apply'> current </#if>" href="${request.contextPath }/admin/apply/list"><span aria-hidden="true" class="icon-warning-sign"></span>申报记录</a>
			  </li>
	      </ul>
	    </div>
	  </div>
